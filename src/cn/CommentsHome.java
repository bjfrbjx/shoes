...
public class CommentsHome {
	...
	public Comments merge(Comments detachedInstance) {
		...
		try {
			Comments result = (Comments) sessionFactory.getCurrentSession().merge(detachedInstance);
	...
	public Comments findById(java.lang.Integer id) {
		...
		try {
			Comments instance = (Comments) sessionFactory.getCurrentSession().get("cn.Comments", id);
			if (instance == null) {
	...
	public List findByExample(Comments instance) {
		...
		try {
			List results = sessionFactory.getCurrentSession().createCriteria("cn.Comments")
