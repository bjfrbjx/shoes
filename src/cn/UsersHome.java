...
public class UsersHome {
	...
	public Users findById(java.lang.Integer id) {
		...
		try {
			Users instance = (Users) sessionFactory.getCurrentSession().get("cn.Users", id);
			if (instance == null) {
	...
	public List findByExample(Users instance) {
		...
		try {
			List results = sessionFactory.getCurrentSession().createCriteria("cn.Users").add(Example.create(instance))
					.list();
