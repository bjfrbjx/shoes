...
public class OrdersHome {
	...
	public Orders findById(java.lang.String id) {
		...
		try {
			Orders instance = (Orders) sessionFactory.getCurrentSession().get("cn.Orders", id);
			if (instance == null) {
	...
	public List findByExample(Orders instance) {
		...
		try {
			List results = sessionFactory.getCurrentSession().createCriteria("cn.Orders").add(Example.create(instance))
					.list();
