...
<%
if(user!=null){%>
Hello <%=user.getName() %>!<a href="/struts2/login.jsp">换号</a>---<a href="logout">注销</a>---<a href="/struts2/index.jsp">首页</a>---<a href="/struts2/main/main.jsp">主页</a>
<% } else{%>
...
<% }%>
<% if(isadmin!=null&&isadmin==true){ %>	<a href="/struts2/main/admin.jsp">管理</a> <% }%>